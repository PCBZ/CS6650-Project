...
type BatchGetPostsRequest struct {
	...
	UserIds       []int64                `protobuf:"varint,1,rep,packed,name=user_ids,json=userIds,proto3" json:"user_ids,omitempty"` // Required: List of user IDs whose posts to retrieve
	Limit         int32                  `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`                           // Optional: Maximum posts per user (default: 50)
...
type BatchGetPostsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserPosts     map[int64]*UserPosts   `protobuf:"bytes,1,rep,name=user_posts,json=userPosts,proto3" json:"user_posts,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Map of user_id to their posts
	ErrorMessage  string                 `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`                                                                   // Error message if request failed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BatchGetPostsResponse) GetUserPosts() map[int64]*UserPosts {
	if x != nil {
		return x.UserPosts
	}
	return nil
...
type UserPosts struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Posts         []*Post                `protobuf:"bytes,1,rep,name=posts,proto3" json:"posts,omitempty"` // List of posts for this user
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Post struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PostId        int64                  `protobuf:"varint,1,opt,name=post_id,json=postId,proto3" json:"post_id,omitempty"` // Post ID
	UserId        int64                  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // ID of the user who created the post
	Content       string                 `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`              // Post content
	Timestamp     int64                  `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`         // Unix timestamp of when the post was created
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_post_post_proto_rawDesc = "" +
	"\n" +
	"\x15proto/post/post.proto\x12\x04post\"G\n" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\x1aM\n" +
	"\x0eUserPostsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12%\n" +
	"\x05value\x18\x02 \x01(\v2\x0f.post.UserPostsR\x05value:\x028\x01\"-\n" +
	"\tUserPosts\x12 \n" +
...
var file_proto_post_post_proto_goTypes = []any{
	...
	(*UserPosts)(nil),             // 2: post.UserPosts
...
var file_proto_post_post_proto_depIdxs = []int32{
	...
	3, // 1: post.UserPosts.posts:type_name -> post.Post
	2, // 2: post.BatchGetPostsResponse.UserPostsEntry.value:type_name -> post.UserPosts
